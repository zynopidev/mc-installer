...
read mc_installdir
echo -e "Choose version of paper you want install (1.7.10, 1.8.8, 1.9.4, 1.10.2, 1.11.2, 1.12.2, 1.13.2, 1.14.4, 1.15.2, 1.17.1, 1.18.2, 1.19.4, 1.20.6, 1.21.10): "
read mc_installver
echo -e "Select a network port: "
read mc_serverport
echo -e "Select RAM you want allocate to server (512M, 1024M, 2048M, 4096M etc...): "
read mc_serverram
echo -e "Name of you mc-session in screen: "
read mc_sessionname
echo
...
echo "screen -s Minecraft-$mc_sessionname /usr/lib/jvm/java-8-openjdk-amd64/ java -Xmx4096M -Xms4096M -jar $mc_installdir/server.jar" > $mc_installdir/run.sh ;
